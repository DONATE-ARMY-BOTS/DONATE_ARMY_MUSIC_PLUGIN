...
from DONATE_ARMY_MUSIC.utils.database import get_served_chats

# Convert AUTO_GCAST to boolean based on "On" or "Off"
AUTO_GCASTS = AUTO_GCAST.strip().lower() == "on"

START_IMG_URLS = "https://telegra.ph/file/a1ee9c24963567afc3907.jpg"

MESSAGES = f"""**☄️ᴊᴏɪɴ ᴏᴜʀ ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ 🔗:- https://t.me/DONATE_ARMY_BOTS

ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴇᴀᴛ ɢʀᴏᴜᴘ :- https://t.me/DONATE_ARMY_BOTS_CHAT_GROUP
