    ...
    if user_id in administrators:
        if data == "add_night":
            if check_night:
                ...
                await query.message.edit_caption(
                    "**๏ ᴀᴅᴅᴇᴅ ᴄʜᴀᴛ ᴛᴏ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ . ᴛʜɪs ɢʀᴏᴜᴘ ᴡɪʟʟ ʙᴇ ᴄʟᴏsᴇᴅ ᴏɴ 𝟷𝟷ᴀᴍ [IST] ᴀɴᴅ ᴡɪʟʟ ᴏᴘᴇɴᴇᴅ ᴏɴ 𝟶𝟼ᴀᴍ [IST] .**"
                )
        if data == "rm_night":
            if check_night:
...
- Nɪɢʜᴛᴍᴏᴅᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʏ ᴄᴏsᴇs ᴛʜᴇ ᴄʜᴀᴛ ᴅᴜʀɪɴɢ ɴɪɢʜᴛ ʜᴏᴜʀs (11:00 AM ᴛᴏ 6:00 AM) ᴀɴᴅ ᴏᴘᴇɴs ɪᴛ ɪɴ ᴛʜᴇ ᴍᴏʀɴɪɴɢ.
